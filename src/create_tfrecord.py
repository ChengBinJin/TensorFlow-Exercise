...
def get_example_object(data_record):
    ...
    # Convert string data into list of byes
    ...
    example_ = tf.train.Example(features=features)

    return example_

with tf.python_io.TFRecordWriter('./data/example.tfrecord') as tfwriter:
    # Iterate through all records
    for data_record_ in data_arr:
        example = get_example_object(data_record_)
